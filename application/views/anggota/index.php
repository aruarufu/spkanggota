...
<div class="col-lg-12">
                    ...
                    <table class="table table-hover">
                        ...
                        if (isset($anggota)) {
                            ...
                            foreach ($anggota as $item) {
                                ...
                                <tr>
                                    <td><?php echo $no++ ?></td>
                                    <td><?php echo $item->anggota ?></td>
                                    <td>
                                        <a class="btn btn-primary btn-xs"
                                           href="<?php echo site_url('anggota/tambah/' . $item->kdAnggota) ?>"
                                           role="button">
    ...
    <div class="row">
        <div class="form-group">
            <a href="<?php echo site_url('anggota/tambah') ?>" type="button" class="btn btn-primary">Tambah
                Anggota</a>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger"
                        onclick="hapus_anggota(<?php echo $item->kdAnggota; ?>)">
                    Hapus
                </button>
            </div>
        </div><!-- /.modal-content -->
